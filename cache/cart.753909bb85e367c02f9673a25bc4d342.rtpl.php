                                ...
                                <div class="cart_totals ">
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="shipping">
                                                <th>Frete</th>
                                                <td>R$ <?php if( $cart["nrdays"] > 0 ){ ?><?php echo formatPrice($cart["vlfreight"]); ?>  <small>prazo de <?php echo htmlspecialchars( $cart["nrdays"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dia(s)</small><?php } ?></td>
                                            </tr>
